...
/**
 * check97 - checks the correct No of arguments
...
/**
 * check98 - checks file_from exists that can be read
 ...
 * @fd_from: file descriptor of file_from to close
 * @fd_to: file descriptor of file_to, or -1
 *
 * Return: void
 */
...
/**
 * check100 - checks that file descriptors is properly closed
 * @check: checks if true or false
 * @fd: file descriptor
 *
 * Return: void
...
/**
 * main - copies the content of a file to new file.
